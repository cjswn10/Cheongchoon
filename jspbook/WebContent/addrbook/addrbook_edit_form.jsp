...
<H2>내 정보 수정 </H2>
<HR>
[<a href=addrbook_control.jsp?action=list>목록</a>] <p>
...
<table border="1">
  ...
  <tr>
    <th>제목</th>
    <td><input type="text" name="ab_email" value="<%=ab.getAb_birth() %>"></td>
  </tr>
    <tr>
    <th>전화번호</th>
    <td><input type="text" name="ab_tel" value="<%=ab.getAb_tel() %>"></td>
      ...
      <tr>
    <th>email</th>
    <td><input type="email" name="ab_birth" value="<%=ab.getAb_email() %>"></td>
  </tr>
  <tr>
    <th>질문사항</th>
